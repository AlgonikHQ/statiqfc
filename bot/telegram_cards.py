...
def buttons_result():
    return [
        [
            {"text": "\U0001f4ca Full Record", "url": "https://t.me/+u3BbsvIdBAY4Zjlk"},
            {"text": "\U0001f4c5 Fixtures",    "url": "https://www.premierleague.com/fixtures"}
        ],
        [
            {"text": "\u26a0\ufe0f Bet Responsibly", "url": "https://www.begambleaware.org"}
...
def buttons_vip():
    return [
        [
            {"text": "\U0001f4ca Our Record",      "url": "https://t.me/+u3BbsvIdBAY4Zjlk"},
            {"text": "\u26a0\ufe0f Bet Responsibly", "url": "https://www.begambleaware.org"}
        ]
    ]
...
def card_result(selection, roi):
    ...
    if roi:
        ...
        roi_line = (
            ...
            "\n  \u2705 " + str(roi["wins"]) + "W  \u274c " + str(roi["losses"]) + "L" +
...
def card_vip_unlock(roi):
    """Threshold-hit alert: fires to private DM when 100 picks @ +8% ROI is reached.
    Signals readiness to wire up paid VIP and announce launch."""
    return (
        "\U0001f6a8 *VIP THRESHOLD REACHED*\n"
        "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\n"
        "The model has hit the founding-member threshold.\n\n"
        "*Current stats:*\n"
        "  Picks: " + str(roi.get("selections", roi.get("picks", "?"))) + "\n"
        "  ROI: +" + str(roi.get("roi_pct", "?")) + "%\n\n"
        "*Time to action:*\n"
        "  1. Set up payment processing (Telegram Stars or Stripe)\n"
        "  2. Lock current VIP roster as founding members (free for life)\n"
        "  3. Generate new gated invite link (paid only)\n"
        "  4. Announce paid launch in @StatiqFCpicks with 14-day notice\n"
        "  5. Update card_public_welcome and card_vip_welcome wording\n\n"
        "Public credibility is at peak \u2014 capitalise now."
    )
...
def card_morning_no_fixtures():
    return (
        "⚽ *StatiqFC — Morning Briefing*\n"
        "━━━━━━━━━━━━━━━━━\n"
        "No fixtures scheduled across our tracked leagues today.\n\n"
        "No action today — we only post when the data says so.\n\n"
        "_Tracking: PL · Championship · Bundesliga · Serie A · Ligue 1 · La Liga · Eredivisie · Primeira Liga_"
    )
...
def card_vip_welcome():
    """One-shot welcome message for VIP channel StatiqFCVIP — founding member framing."""
    return (
        "\U0001f48e *Welcome to StatiqFC VIP \u2014 Founding Members*\n"
        "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\n"
        "\n"
        "You're in early. This room is where the picks fire \u2014 live,\n"
        "before kickoff, with full reasoning behind every call.\n"
        "\n"
        "\U0001f4cd *What you'll see here*\n"
        ...
        "\n"
        "\U0001f3af *Founding Member status*\n"
        "   The model is currently in training & validation phase.\n"
        "   VIP is FREE while we build the track record.\n"
        "\n"
        "   When we hit our threshold \u2014 100 picks at +8% ROI \u2014\n"
        "   VIP moves to a paid tier (\u00a35/month).\n"
        "\n"
        "   \U0001f451 *Founding members joining now keep FREE access for life.*\n"
        "\n"
        "   You're not paying yet. You're getting in before the door closes.\n"
        "\n"
        "\U0001f4ca *How to track our progress*\n"
        "   The public channel @StatiqFCpicks shows every result, every day.\n"
        "   When we hit 100 picks at +8% ROI, paid launch begins.\n"
        "\n"
        "\u26a0\ufe0f Paper portfolio only. No financial advice. 18+ Gamble responsibly.\n"
        "\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501"
    )
